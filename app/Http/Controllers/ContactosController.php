...
class ContactosController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('contactos')->with('Mensaje','Contacto ha sido agregado correctamente');
    }
    ...
    public function update(Request $request, $id)
    {
       ...
       //return view('contactos.edit',compact('contacto'));
       return redirect('contactos')->with('Mensaje','El contacto ha sido modificado correctamente');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('contactos')->with('Mensaje','El contacto ha sido eliminado correctamente');
    }
}
